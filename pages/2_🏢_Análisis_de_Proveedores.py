...
def to_excel(df: pd.DataFrame) -> bytes:
    ...
    # Itera sobre cada columna para remover la información de zona horaria, que no es compatible con Excel.
...
# Se calculan los proveedores que tienen deuda real. Esto ya no debe fallar.
...
with tab1:
    ...
    # Cálculo robusto del plazo promedio, ignorando filas con fechas faltantes.
    plazos_validos = (supplier_df['fecha_vencimiento_erp'] - supplier_df['fecha_emision_erp']).dropna()
    avg_plazo = plazos_validos.dt.days.mean()
